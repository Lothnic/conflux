...
## Corpus Check
- 65 files · ~25,923 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 417 nodes · 682 edges · 34 communities (23 shown, 11 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 11 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f2b714c5`
...
- `test_issue_heuristics_cover_expected_categories()` --calls--> `infer_issue_type()`  [EXTRACTED]
  tests/test_core.py → app/services/proposal_heuristics.py
...
Cohesion: 0.12
Nodes (22): Counter, Backward-compatible shim — delegates to app.core.database.  New code should impo, Conflux Backend — Civic-tech AI Platform Author: Lothnic  This module creates th, _cosine(), _load_docs(), PolicyHit, Lightweight local policy retrieval for the planning agent.  This is intentionall, retrieve_policy() (+14 more)
...
Cohesion: 0.07
Nodes (47): database_available(), init_db_sync(), Create tables if the database is available. Returns False otherwise., get_clusters(), get_clusters_geojson(), Cluster-related endpoints., Return latest cluster summaries from the DB., Return cluster centroids as GeoJSON FeatureCollection. (+39 more)
...
- **Why does `init_db_sync()` connect `Database Layer` to `Community 16`, `Community 28`?**
