...
## Corpus Check
- 65 files · ~26,060 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 423 nodes · 700 edges · 33 communities (23 shown, 10 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 11 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6dccdddb`
...
Cohesion: 0.06
Nodes (48): cluster_results Table, daily_ingest Table, Backward-compatible shim — delegates to app.core.database.  New code should impo, 1. System Architecture, 2. Reddit Ingestion Strategy, 3. Database Schema, 4. Data Flow, 5. Tech Stack Summary (+40 more)
...
Cohesion: 0.12
Nodes (36): Any, Counter, _cosine(), _load_docs(), PolicyHit, Lightweight local policy retrieval for the planning agent.  This is intentionall, retrieve_policy(), _tf() (+28 more)
...
Cohesion: 0.09
Nodes (30): database_available(), init_db_sync(), Create tables if the database is available. Returns False otherwise., get_clusters(), get_clusters_geojson(), Cluster-related endpoints., Return latest cluster summaries from the DB., Return cluster centroids as GeoJSON FeatureCollection. (+22 more)
...
Cohesion: 0.12
Nodes (23): Engine, AsyncEngine, AsyncSession, Connection, create_async_engine_instance(), create_sync_engine(), create_tables(), _ensure_columns() (+15 more)
...
- **Why does `init_db_sync()` connect `Community 16` to `Backend API & Complaint Processing`, `Database Layer`, `Community 28`?**
...
- **Should `Policy Research & Agent Pipeline` be split into smaller, more focused modules?**
